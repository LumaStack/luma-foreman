...
**Carve-out (2026-08-09):** the rule does not apply in `luma-hq`, the private organization-level repository. Holding competitive analysis is part of that repository's stated job, and its README records the exception.
