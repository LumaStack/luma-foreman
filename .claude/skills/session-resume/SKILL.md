...
<!-- luma-foreman:generated from lumastack/luma-catalog/session-manager workflows/session-resume. Regenerate with `luma-foreman apply`; edits are lost. -->

# Resume a session

**Read `.luma/bundles/lumastack/luma-catalog/session-manager/workflows/session-resume.md` and follow it.** That file is the workflow. This is the adapter that makes it reachable from here, and it deliberately carries no copy of it — the copy would drift.
