# Changelog — `session_note`

The history of the `session_note` Type Definition, newest first, keyed by the
...
- Versioning begins: the type declares its own `version`, independent of
  ...
  definition now lives at `type_definitions/session_note/DEFINITION.md`, with
