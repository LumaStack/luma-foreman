...
- `type_definitions/coverage/DEFINITION` (type_definition)
- `type_definitions/journal/DEFINITION` (type_definition)
- `type_definitions/slice/DEFINITION` (type_definition)
- `type_definitions/sweep/DEFINITION` (type_definition)
