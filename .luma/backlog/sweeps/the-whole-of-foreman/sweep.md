...
| cluster | file | read by | status | slice |
| --- | --- | --- | --- | --- |
| what it says it is | `README.md` | both | pending | |
...
Already, before slice 001: **the agent-reads-first exception is framed per
file, not per area.** [[the-pairing-turn]] permits it for *"generated code, a
