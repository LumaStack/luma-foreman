...
[[work-items/FORE-0030-a-committed-per-project-permission-floor-under-the-machine-local-layer]] and
[[work-items/FORE-0031-distribution-foreman-installs-by-clone-and-symlink]].

## Related work

- Born from the idea it replaces: [`named-permission-profiles`](../../ideas/named-permission-profiles.md)
