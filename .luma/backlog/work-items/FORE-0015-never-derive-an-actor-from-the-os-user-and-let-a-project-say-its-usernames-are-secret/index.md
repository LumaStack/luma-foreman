...
description: That last point is the real design question and it is not obvious. Sweep `the-whole-of-foreman`, slice 001. The leak reached `.luma/backlog/sweeps/`, two files in the published `review-sweeps` bundle, and four commits of git history.
modified: {by: 'agent:claude-opus-5/luma-backlog', at: '2026-09-24T19:43:38Z'}
---

# Never derive an actor from the OS user, and let a project say its usernames are secret
...
- Born from the idea it replaces: [`never-derive-an-actor-from-the-os-user`](../../ideas/never-derive-an-actor-from-the-os-user.md)
