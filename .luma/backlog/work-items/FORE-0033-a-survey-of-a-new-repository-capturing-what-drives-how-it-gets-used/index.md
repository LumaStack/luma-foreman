...
description: When setting up a new repo, capture infromation that will drive how it gets used now and later. Ensure these are fluid and don't rot. Migrated from `docs/IDEAS.md` on 2026-08-21, verbatim including its typos. `created.at` is a day-level estimate from git history.
...
- *how established is this project* is the subject of
  [[work-items/FORE-0048-declared-maturity-and-behaviour-that-respects-it]], filed in this repository. It covers
  declaring maturity and behaving differently in response, and notes that LKF's
  `stage` already supplies the vocabulary.
...
- Born from the idea it replaces: [`new-repository-survey`](../../ideas/new-repository-survey.md)
