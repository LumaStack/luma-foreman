...
description: '`inspect --rule adoption` reports three states, and the first one is this idea described as a failure:'
...
- Born from the idea it replaces: [`a-bundle-should-be-able-to-diverge`](../../ideas/a-bundle-should-be-able-to-diverge.md)
