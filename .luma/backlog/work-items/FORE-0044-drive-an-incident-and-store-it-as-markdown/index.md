...
description: 'When something goes wrong, foreman runs the response rather than leaving it to memory and chat: prompts for what is known, tracks what has been tried, and captures the timeline as it happens rather than reconstructing it afterward. The record is markdown, committed in the affected project.'
...
- Born from the idea it replaces: [`drive-an-incident`](../../ideas/drive-an-incident.md)
