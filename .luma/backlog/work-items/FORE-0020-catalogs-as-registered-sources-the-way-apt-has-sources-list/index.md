...
- **An `apt update`-style index cache.** Catalogs are git repositories
  ...
  [[work-items/FORE-0047-browsing-a-catalog-is-an-engine-s-job-not-a-catalog-s]].
...
- Born from the idea it replaces: [`catalogs-as-registered-sources`](../../ideas/catalogs-as-registered-sources.md)
