...
description: Spelling, terminology, house style. It would apply to every bundle, including the ones already written. The catalog carried 67 `-ize` spellings against 6 `-ise` ones, and nothing anywhere declared which was correct. The convention existed only as weight of usage, which is exactly how the six got in — nobody was wrong, because there was nothing to be wrong about.
modified: {by: 'agent:claude-opus-5/luma-backlog', at: '2026-09-24T19:43:44Z'}
---

# A prose conventions bundle — spelling, terminology, house style
...
- Born from the idea it replaces: [`prose-conventions`](../../ideas/prose-conventions.md)
