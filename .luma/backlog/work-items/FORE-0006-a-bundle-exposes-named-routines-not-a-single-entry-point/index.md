...
kind: idea
stage: draft
created: {by: 'human:luma-founder', at: '2026-08-23T00:00:00'}
description: 'workflows-invoking-workflows designed the caller: an `invokes:` block, a `luma-invoke:` marker, four levels, absence handling. Its `bundle:` target resolves to the bundle''s `entry_point` — one way in, decided by the callee''s author, the same one for every caller.'
modified: {by: 'agent:claude-opus-5/luma-backlog', at: '2026-09-24T19:43:36Z'}
---
...
[[work-items/FORE-0005-a-shared-language-for-workflows-invoking-other-workflows]] designed the **caller**: an `invokes:` block, a
...
path instead of a predicate evaluating into one. [[work-items/FORE-0049-routers-conditional-decision-logic-for-what-gets-loaded]] gets stuck on
...
- **[[work-items/FORE-0005-a-shared-language-for-workflows-invoking-other-workflows]]** — *"a trigger is conditional on presence,
...
[[work-items/FORE-0005-a-shared-language-for-workflows-invoking-other-workflows]] — the caller's half; this is the callee's.
[[work-items/FORE-0049-routers-conditional-decision-logic-for-what-gets-loaded]] — the same problem approached as evaluation rather than as naming.
...
- Born from the idea it replaces: [`bundle-routines`](../../ideas/bundle-routines.md)
