...
description: 'Taking a bundle is two commands, and it is two commands on purpose: `get` copies a directory and writes a receipt, `apply` writes what agents read, and the gap between them is the `unapplied` finding — a bundle present, checksummed, reported clean, and seen by nobody.'
...
- Born from the idea it replaces: [`adopt-or-install-as-shorthand`](../../ideas/adopt-or-install-as-shorthand.md)
