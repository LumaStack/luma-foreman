...
kind: idea
stage: draft
created: {by: 'human:luma-founder', at: '2026-08-27T00:00:00'}
description: 'Anything beyond those four is content, and content is what this change moves out. Three reasons, none of which is context cost: Measured in this repository at 17 adopted bundles, 2026-08-27: The naive version is an index of everything, which is what exists today. The replacement is recursive: each level carries what is always-on here, advertises what is reachable from here with enough detail to choose, and defers the rest.'
...
it installs — [[work-items/FORE-0010-there-is-no-way-to-un-adopt-a-bundle]] — and naming a specific bundle compiles a
...
**Not a variation of [[work-items/FORE-0049-routers-conditional-decision-logic-for-what-gets-loaded]]**, which is the concept — conditional loading,
...
**Answers [[work-items/FORE-0007-projected-through-an-index-preload-levels-differ-only-in-emphasis]]**, which found the declared
...
**Meets [[work-items/FORE-0006-a-bundle-exposes-named-routines-not-a-single-entry-point]] where a bundle's own routing lives.** That entry asks
...
- Born from the idea it replaces: [`apply-writes-an-entry-point-not-an-index`](../../ideas/apply-writes-an-entry-point-not-an-index.md)
