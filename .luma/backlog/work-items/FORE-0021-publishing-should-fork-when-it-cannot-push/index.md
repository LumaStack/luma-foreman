...
description: 'The push to `origin` fails, and the refusal says so: Which is honest, and is also the point at which somebody publishing their first bundle stops.'
...
- Born from the idea it replaces: [`publishing-should-fork-when-it-cannot-push`](../../ideas/publishing-should-fork-when-it-cannot-push.md)
