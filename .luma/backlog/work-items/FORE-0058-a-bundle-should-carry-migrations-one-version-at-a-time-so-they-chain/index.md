...
description: Split from classify-bundle-contents, where it is one item in a larger list.
...
Split from [[work-items/FORE-0057-lkf-and-bundles-need-improved-classifications-for-special-contents]], where it is one item in a larger list.
...
**Distinct from [[work-items/FORE-0064-frontmatter-needs-a-version-and-a-type-definition-needs-migrations]], and
...
- Born from the idea it replaces: [`migrate-a-bundle-one-version-at-a-time`](../../ideas/migrate-a-bundle-one-version-at-a-time.md)
