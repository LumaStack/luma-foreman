...
kind: idea
stage: draft
created: {by: 'human:luma-founder', at: '2026-08-19T00:00:00'}
description: A repo or LKF document can declare it's maturity. Repos can declare in README.md, CLAUDE.md, or maybe one or two other places. We need to provide a list of maturities. Maybe we already have them and can use what's already provided by LKF. And then a when a repo has a declared maturity we can behave in different ways. When something is brand new we should stop saying things like, this is already established so we have to follow this or that rule. And when it's very stable and established we have to treat most things like they are law.
...
format defines `stage` as a core field, `draft | provisional | stable
...
- Born from the idea it replaces: [`declared-maturity-and-behaviour`](../../ideas/declared-maturity-and-behaviour.md)
